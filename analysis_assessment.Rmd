...
```{r, include=FALSE}
sims_FF <- read_csv("Results/assessment/sim-spvars-FALSE_spnoise-FALSE_100x100-500_cv4x4-k10-buffer15_seed500_noisier.csv")
...
sims_TT <- read_csv("Results/assessment/sim-spvars-TRUE_spnoise-TRUE_100x100-500_cv4x4-k10-buffer15_seed500_noisier.csv")
```
