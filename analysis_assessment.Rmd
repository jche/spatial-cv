...
```{r, include=FALSE}
sims_FF <- read_csv("Results/assessment/sim-spvars-FALSE_spnoise-FALSE_100x100-500_cv4x4-k10-buffer10_seed17776.csv")
sims_FT <- read_csv("Results/assessment/sim-spvars-FALSE_spnoise-TRUE_100x100-500_cv4x4-k10-buffer10_seed17776.csv")
sims_TF <- read_csv("Results/assessment/sim-spvars-TRUE_spnoise-FALSE_100x100-500_cv4x4-k10-buffer10_seed17776.csv")
sims_TT <- read_csv("Results/assessment/sim-spvars-TRUE_spnoise-TRUE_100x100-500_cv4x4-k10-buffer10_seed17776.csv")
```
